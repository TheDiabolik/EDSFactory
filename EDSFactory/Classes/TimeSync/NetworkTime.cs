...
namespace EDSFactory
{
    ...
    public class NTPClient
    {
        ...
        public bool Connect1(bool UpdateSystemTime)
        {
            ...
            try
            {
                ...
                IPEndPoint EPhost = new IPEndPoint(IPAddress.Parse(TimeServer), 123);
        ...
        public bool Connect(bool UpdateSystemTime)
        {
            ...
            try
            {
                ...
                // Initialize data structure
                Initialize();
                int asd = TimeSocket.Send(NTPData, NTPData.Length);
                ...
                do
                {
                    ...
                    available = TimeSocket.Available;
                    
                    if (available > 0)  // <----- THIS IS SEXY
                    {
                        NTPData = TimeSocket.Receive(ref EPhost);
                    }
        ...
        //    {
        //        // Resolve server address
        //        //IPHostEntry hostadd = Dns.GetHostByAddress(TimeServer);
        //        //IPHostEntry hostadd = Dns.GetHostEntry(TimeServer);
        ...
        //        return catcher;
        //    }
        //    catch (ObjectDisposedException cxxcef)
        //    {
        //        catcher = false;
        //        return catcher;
        //    }
        //    catch (SocketException cxef)
        //    {
        //        catcher = false;
        //        return catcher;
        //    }
